...
public class WinLoseManager : MonoBehaviour
{
    ...
    {
        //Win Lose Text
        if(ComInfo.getGameResult() == result.win)   winLoseText.GetComponent<Text>().text = "Victory!";
        else if(ComInfo.getGameResult() == result.lose)   winLoseText.GetComponent<Text>().text = "Defeat!";
